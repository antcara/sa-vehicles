...
const HomePage = () => {
  ...
  return (
    <div className="relative space-y-10">
      ...
      {/* Main layout with full-width background image */}
      <div className="relative w-full">
        ...
        {/* Content container */}
        <div className="flex flex-col lg:flex-row gap-8 relative z-10 py-8 max-w-6xl mx-auto px-4">
          {/* Search and Filters - Half width on desktop, full on mobile */}
          <div className="w-full lg:w-1/2 p-6 rounded-lg bg-white/90 backdrop-blur-sm shadow-lg">
            {/* Search content */}
          ...
          <div className="w-full lg:w-1/2 p-6 rounded-lg flex items-center justify-center">
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-lg">
                Use our powerful search tools to discover vehicles that match your budget and preferences.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Car Results - Below the full-width background section */}
      <div className="max-w-6xl mx-auto px-4 w-full mt-8">
        <h2 className="text-xl font-semibold mb-4">Found {displayCars.length} vehicles</h2>
